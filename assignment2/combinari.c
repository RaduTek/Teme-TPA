...
/// @brief Verifica daca indicele p a fost folosit in combinare
...
/// @brief Genereaza combinarile multimii la nivelul p
...
/// @return Numarul de combinari generate
...
int main()
{
    ...
    k = read_var("Introdu numarul de combinari k=");
    ...
    printf("Combinari de %u luate cate %u ale multimii:\n", n, k);
    int count = combinari(n, k, multime, rezultat, 0);
    printf("Au fost generate %u combinari.\n", count);
